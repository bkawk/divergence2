...
priceSchema.index({localTime: 1, pair: 1, timeFrame: 1}, {unique: true});
// second index, unique index
// priceSchema.index({time: 1, open: 1, close: 1, high: 1, low: 1, volume: 1, pair: 1, timeFrame: 1}, {unique: true});
// static methods
